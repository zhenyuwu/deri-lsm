...
public class ConstantsUtil {
	public static final String databaseName = "your database";
	...
	/*---------------------------------- for the data feed ----------------------------------*/
	public static final String data_feed_prefix = "http://localhost:8080/lsmfeed";
	...
	public static final String gmarker_icon_cosm = "/imgs/sensortype/icon_cosm.png";
	...
	static{
		dataSourceType.put(SourceType.yahoo.toString(),dataSourct_type_yahoo_description);
		dataSourceType.put(SourceType.australia.toString(),dataSourct_type_australia_description);
		dataSourceType.put(SourceType.wunderground.toString(),dataSourct_type_weatherbug_description);
		dataSourceType.put(SourceType.weatherbug.toString(),dataSourct_type_wunderground_description);
		dataSourceType.put(SourceType.others.toString(),dataSourct_type_other_description);
		
		dataSourceLogo.put(SourceType.yahoo.toString(), dataSource_type_yahoo_logo);
		dataSourceLogo.put(SourceType.australia.toString(), dataSource_type_australia_logo);
		dataSourceLogo.put(SourceType.wunderground.toString(), dataSource_type_weatherbug_logo);
		dataSourceLogo.put(SourceType.weatherbug.toString(), dataSource_type_wunderground_logo);
		dataSourceLogo.put(SourceType.others.toString(), dataSource_type_other_logo);
	}
}
