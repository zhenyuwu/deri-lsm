...
<xsl:stylesheet
   ...
   xmlns:yweather="http://xml.weather.yahoo.com/ns/rss/1.0">
	...
	<xsl:template match="/">
		...
		<xsl:call-template name="observes"/>
	...
	<xsl:template name="information">	
		...
		<xsl:value-of select="concat('&#10;','&#60;',$sensorId,'&#62; ',
	    			...
	    			concat('&#60;',$sensorId,'&#62; ',
	    			'&#60;','http://lsm.deri.ie/ont/lsm.owl#hasSensorType','&#62; ','&#60;',$sensorTypeId,'&#62; ','.'),
	    			concat('&#60;',$sensorTypeId,'&#62; ',
	    			'&#60;','http://www.w3.org/1999/02/22-rdf-syntax-ns#type','&#62; ','&#60;','http://lsm.deri.ie/ont/lsm.owl#SensorType','&#62;','.'),	    			
	    			concat('&#60;',$sensorTypeId,'&#62; ',
	    			'&#60;','http://www.w3.org/2000/01/rdf-schema#label','&#62; ','&#34;',$sensortype,'&#34;','.'),
	    			concat('&#60;',$sensorId,'&#62; ',
	    			'&#60;','http://lsm.deri.ie/ont/lsm.owl#isAddedBy','&#62; ','&#60;',$userId,'&#62;.')	    			
           			" separator="&#10;"/>
	</xsl:template>
	
	<xsl:template name="observes">		
		<xsl:for-each select="document('../xslt/observedproperty.xml')/Root/sensors/sensor[type=$sensortype]/observes">
		<xsl:variable name="observes" select="."/>
		<xsl:variable name="observesId" select="document('../xslt/observedproperty.xml')/Root/items/item[name=$observes]/url"/>
		<xsl:variable name="class" select="document('../xslt/observedproperty.xml')/Root/items/item[name=$observes]/class"/>
		<xsl:value-of select="concat('&#10;','&#60;',$sensorId,'&#62; ',
